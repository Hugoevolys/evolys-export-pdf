...
import { Loader2, Search, MapPin, Building2, Hammer, ArrowLeft, RotateCcw } from 'lucide-react';
  ...
  return (
    <div className="card space-y-6">
      ...
      <div className="rounded-2xl bg-navy text-white p-6 grid grid-cols-2 gap-4">
        <div>
          <div className="text-xs uppercase tracking-wide text-white/60">Total projet estimé</div>
        ...
        <div className="border-l border-white/20 pl-4">
          <div className="text-xs uppercase tracking-wide text-white/60">Coût au m²</div>
      ...
      <div className="rounded-xl border border-slate-200 bg-slate-50/50 p-4 text-sm space-y-1">
        ...
        <Row label="Total projet" value={euro(data.totalProjet)} bold />
      </div>
